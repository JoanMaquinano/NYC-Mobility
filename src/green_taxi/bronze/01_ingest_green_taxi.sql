...
USING (
    SELECT
        ...
        'green_tripdata_${year_month}.parquet' AS source_file
    FROM read_files('/Volumes/workspace/default/ftw-b12-de/groups/week-08/group-d/green-taxi/green_tripdata_${year_month}.parquet', format => 'parquet')
) AS s
